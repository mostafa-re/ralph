...
if REDIS_SENTINEL_ENABLED:
    ...
    REDIS_SENTINEL_HOSTS = get_sentinels(
        os.environ.get("REDIS_SENTINEL_HOSTS", None)
    )  # noqa
...
MY_EQUIPMENT_REPORT_FAILURE_URL = os.environ.get(
    "MY_EQUIPMENT_REPORT_FAILURE_URL", ""
)  # noqa
...
# Networks
DEFAULT_NETWORK_BOTTOM_MARGIN = int(
    os.environ.get("DEFAULT_NETWORK_BOTTOM_MARGIN", 10)
)  # noqa
DEFAULT_NETWORK_TOP_MARGIN = int(
    os.environ.get("DEFAULT_NETWORK_TOP_MARGIN", 0)
)  # noqa
